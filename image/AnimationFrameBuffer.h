...
/**
 * An AnimationFrameRetainedQueue will retain all of the frames inserted into
 * it. Once it crosses its maximum number of frames, it will recommend
 * conversion to a discarding queue.
 */
class AnimationFrameRetainedQueue final : public AnimationFrameBuffer
{
public:
 ...
 * animated images where we decoded the full sized frames off the main thread,
